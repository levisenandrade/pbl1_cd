module ContadorHsync(
    input  wire clk,      // Clock de entrada (25MHz direto para TODOS)
    output wire [9:0] q,  // Saída de 10 bits
    output wire rst_n,    // Saída do reset
    output wire T         // Pulso de fim de linha
);
    ...
    // --- Lógica de Reset (Alvo Exato: 800) ---
    // Ativa quando 512 (q9) + 256 (q8) + 32 (q5) = 800
    and gate_reset (T, q[9], q[8], q[5]);
